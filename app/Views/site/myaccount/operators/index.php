		...
		<?php foreach ($list as $data) {  ?>
			<div class="dashboard-box mt-4">
				<div class="row align-items-center px-2">
					...
					<div class="col-md-4">
						<a class="fs-7 dash-edit" href="<?php echo base_url().'/myaccount/operators/edit/'.$data['id']; ?>">Edit <i class="far fa-edit"></i></a>
...
<script>
	...
	$(document).on('click','.delete',function(){
		var action 	= 	'<?php echo base_url()."/myaccount/operators"; ?>';
		var data   = '\
